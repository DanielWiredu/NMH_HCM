<%@ Page Title="" Language="C#" MasterPageFile="~/Home.Master" AutoEventWireup="true" CodeBehind="NotAwardedProducts.aspx.cs" Inherits="NMH_HCM.UserReports.NotAwardedProducts" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="box box-default">
            <div class="box-header with-border">
              <h3 class="box-title">Not Awarded Products </h3>
...
WHERE        (ClaimsHeader.ClaimsBatchNo = @BatchNo) AND (ClaimsDetails1.ApprovedAmount IS NULL)">
                                    <SelectParameters>
