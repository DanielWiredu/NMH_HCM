<%@ Page Title="" Language="C#" MasterPageFile="~/Home.Master" AutoEventWireup="true" CodeBehind="Tooth_Numbers.aspx.cs" Inherits="NMH_HCM.UserReports.Tooth_Numbers" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="box box-default">
            <div class="box-header with-border">
              <h3 class="box-title">Tooth Numbers </h3>
            ...
            <FooterTemplate>
                ...
                items
                            ...
                            <div>
                                <telerik:RadGrid ID="ToothNoGrid" runat="server" ShowFooter="False" AutoGenerateColumns="False" AllowSorting="True" DataSourceID="toothNoSource" GroupPanelPosition="Top" CellSpacing="-1" GridLines="Both">
                                    <ClientSettings>
                                    ...
                                    <ExportSettings IgnorePaging="true" ExportOnlyData="true" OpenInNewWindow="true" FileName="Tooth_Nos" HideStructureColumns="true">

                                    </ExportSettings>
                                    <MasterTableView DataSourceID="toothNoSource">
                                        <Columns>
                                         <telerik:GridBoundColumn DataField="facility_name" FilterControlAltText="Filter facility_name column" HeaderText="Provider" SortExpression="facility_name" UniqueName="facility_name">
                                         ...
                                         <telerik:GridBoundColumn Aggregate="Count" DataField="toothnos" FilterControlAltText="Filter toothnos column" HeaderText="Tooth No" SortExpression="toothnos" UniqueName="toothnos">
                                ...
                                <asp:SqlDataSource ID="toothNoSource" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="Get_Tooth_Numbers" SelectCommandType="StoredProcedure">
                                    <SelectParameters>
                                        <asp:ControlParameter ControlID="dlProvider" DefaultValue="0" Name="rx_provider_id_master" PropertyName="SelectedValue" Type="Int32" />
