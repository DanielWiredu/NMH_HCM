<%@ Page Title="" Language="C#" MasterPageFile="~/Home.Master" AutoEventWireup="true" CodeBehind="NotEqual_All.aspx.cs" Inherits="NMH_HCM.UserReports.NotEqual_All" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
   <div class="box box-default">
            <div class="box-header with-border">
              <h3 class="box-title">Claimed Not Equal Approved - All </h3>
                        ...
                        <div class="modal-body">
                            ...
                            <div>
                                ...
                                <asp:SqlDataSource ID="notEqualSource" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" 
                                    SelectCommand="SELECT ClaimsHeader.ClaimsBatchNo, ClaimsDetails1.ClaimsNo, Tariff.TariffName, ClaimsDetails1.Claimed, ClaimsDetails1.ApprovedAmount
FROM            Tariff INNER JOIN
                         ClaimsDetails1 ON Tariff.TariffID = ClaimsDetails1.ProductID INNER JOIN
                         ClaimsHeader ON ClaimsDetails1.ClaimsNo = ClaimsHeader.ClaimsNo
WHERE        (ClaimsHeader.ClaimsBatchNo = @BatchNo) AND (ClaimsDetails1.Claimed <> ClaimsDetails1.ApprovedAmount)">
                                    <SelectParameters>
