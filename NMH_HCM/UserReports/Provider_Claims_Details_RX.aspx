<%@ Page Title="" Language="C#" MasterPageFile="~/Home.Master" AutoEventWireup="true" CodeBehind="Provider_Claims_Details_RX.aspx.cs" Inherits="NMH_HCM.UserReports.Provider_Claims_Details_RX" %>
            ...
            <FooterTemplate>
                ...
                items
                            ...
                            <div>
                                    ...
                                    <MasterTableView DataSourceID="claimSource" PageSize="100">
                                        <Columns>
                                         ...
                                         <HeaderStyle Width="70px" />
                                            ...
                                            <telerik:GridBoundColumn DataField="unit_price" DataType="System.Double" FilterControlAltText="Filter unit_price column" HeaderText="unit_price" SortExpression="unit_price" UniqueName="unit_price">
                                            <HeaderStyle Width="80px" />
                                            </telerik:GridBoundColumn>
                                            <telerik:GridBoundColumn DataField="ClaimAmount" DataType="System.Decimal" FilterControlAltText="Filter ClaimAmount column" HeaderText="Amount" SortExpression="ClaimAmount" UniqueName="ClaimAmount">
                                            <HeaderStyle Width="80px" />
                                            </telerik:GridBoundColumn>
                                ...
                                <asp:SqlDataSource ID="claimSource" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="Get_Provider_Claims_Details_RX" SelectCommandType="StoredProcedure">
                                    <SelectParameters>
