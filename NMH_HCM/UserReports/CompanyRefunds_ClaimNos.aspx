<%@ Page Title="" Language="C#" MasterPageFile="~/Home.Master" AutoEventWireup="true" CodeBehind="CompanyRefunds_ClaimNos.aspx.cs" Inherits="NMH_HCM.UserReports.CompanyRefunds_ClaimNos" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="box box-default">
            <div class="box-header with-border">
              <h3 class="box-title">Top Company Refunds - No of Claims </h3>
                                    ...
                                    <MasterTableView DataSourceID="refundSource" PageSize="50">
                                        <Columns>
                                         ...
                                         <HeaderStyle Width="400px" />
                                            ...
                                            <telerik:GridBoundColumn DataField="NoofClaims" DataType="System.Int64" FilterControlAltText="Filter NoofClaims column" HeaderText="No Of Claims" SortExpression="NoofClaims" UniqueName="NoofClaims">
                                            <HeaderStyle Width="120px" />
                                            </telerik:GridBoundColumn>
                                        </Columns>
                                    </MasterTableView>
                                </telerik:RadGrid>
                                <asp:SqlDataSource ID="refundSource" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT top(50)       Vw_Members.Company, COUNT(ClaimsHeader.ClaimsNo) AS NoofClaims
