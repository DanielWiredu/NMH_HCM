<%@ Page Title="" Language="C#" MasterPageFile="~/Home.Master" AutoEventWireup="true" CodeBehind="ClaimsAdviceByDateReceived_MyHealth.aspx.cs" Inherits="NMH_HCM.ClaimsDashboard.ClaimsAdviceByDateReceived_MyHealth" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
    <div class="box box-default">
            <div class="box-header with-border">
              <h3 class="box-title">Claims Advice By Received Date - MYHEALTH</h3>
                    ...
                    <div class="col-md-3">
                            ...
                            <div class="row">
                                <telerik:RadGrid ID="adviceGrid" runat="server" AllowPaging="true" ShowFooter="False" AutoGenerateColumns="true" AllowSorting="False" DataSourceID="adviceSource" GroupPanelPosition="Top" CellSpacing="-1" GridLines="Both">
                                    ...
                                    <ExportSettings IgnorePaging="true" ExportOnlyData="true" OpenInNewWindow="true" FileName="MyHealth_AdviceSlip" HideStructureColumns="true">
                                ...
                                <asp:SqlDataSource ID="adviceSource" runat="server" OnSelecting="adviceSource_Selecting" ConnectionString="<%$ ConnectionStrings:myHealthDBConnectionString %>" SelectCommand="SELECT        ClaimsBatchNo, DateofAttendance,  Inout, DateOfClaim, SysAmountClaimed, SysAmountAwarded, ServiceType, ServiceProvider, ProviderAmountClaimed, Diagnosis, FullName, Company,
