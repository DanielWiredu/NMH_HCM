        ...
        <!-- /.col -->
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT AgeBand, Essential, Executive, Premier, PremierPlus FROM dbo.vAgeBandBenefitClaims(@startdate, @enddate, 'Male', @servicetypeid) AS vAgeBandBenefitClaims_1" OnSelecting="SqlDataSource1_Selecting">
                            <SelectParameters>
                ...
                <div class="row">
                    <div class="col-md-6">
                        ...
                        <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT AgeBand, Essential, Executive, Premier, PremierPlus FROM dbo.vAgeBandBenefitClaims(@startdate, @enddate, 'Female', @servicetypeid) AS vAgeBandBenefitClaims_1" OnSelecting="SqlDataSource3_Selecting">
                            <SelectParameters>
                                <asp:ControlParameter ControlID="dpStartDate" Name="startdate" PropertyName="SelectedDate" />
                                <asp:ControlParameter ControlID="dpEndDate" Name="enddate" PropertyName="SelectedDate" />
                                <asp:ControlParameter ControlID="dlServiceType" Name="servicetypeid" PropertyName="SelectedValue" Type="String" />
                    ...
                    <div class="col-md-6">
                        ...
                        <asp:SqlDataSource ID="SqlDataSource4" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT AgeBand, Essential, Executive, Premier, PremierPlus FROM dbo.vAgeBandBenefitClaimsAmount(@startdate, @enddate, 'Female', @servicetypeid) AS vAgeBandBenefitClaimsAmount_1" OnSelecting="SqlDataSource4_Selecting">
                            <SelectParameters>
                                <asp:ControlParameter ControlID="dpStartDate" Name="startdate" PropertyName="SelectedDate" />
                                <asp:ControlParameter ControlID="dpEndDate" Name="enddate" PropertyName="SelectedDate" />
                                <asp:ControlParameter ControlID="dlServiceType" Name="servicetypeid" PropertyName="SelectedValue" Type="String" />
            ...
            <ChartTitle Text="No of Claims - Benefit Option">
                ...
                <asp:SqlDataSource ID="chartSource" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT BENEFITOPTION, MALES, FEMALES FROM dbo.vBenefitGenderClaims(@startdate, @enddate, @servicetypeid) AS vBenefitGenderClaims_1" OnSelecting="chartSource_Selecting">
                    <SelectParameters>
                                <asp:ControlParameter ControlID="dpStartDate" Name="startdate" PropertyName="SelectedDate" />
                                <asp:ControlParameter ControlID="dpEndDate" Name="enddate" PropertyName="SelectedDate" />
                        <asp:ControlParameter ControlID="dlServiceType" Name="servicetypeid" PropertyName="SelectedValue" Type="String" />
            ...
            <ChartTitle Text="Claim Amount - Benefit Option">
                ...
                <asp:SqlDataSource ID="SqlDataSource5" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT BENEFITOPTION, MALES, FEMALES FROM dbo.vBenefitGenderClaimsAmount(@startdate, @enddate, @servicetypeid) AS vBenefitGenderClaimsAmount_1" OnSelecting="SqlDataSource5_Selecting">
                    <SelectParameters>
                                <asp:ControlParameter ControlID="dpStartDate" Name="startdate" PropertyName="SelectedDate" />
                                <asp:ControlParameter ControlID="dpEndDate" Name="enddate" PropertyName="SelectedDate" />
                                <asp:ControlParameter ControlID="dlServiceType" Name="servicetypeid" PropertyName="SelectedValue" Type="String" />
            ...
            <ChartTitle Text="No of Claims - Age Band">
                ...
                <asp:SqlDataSource ID="SqlDataSource8" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT AGEBAND, MALES, FEMALES FROM dbo.vAgeBandGenderClaims(@startdate, @enddate, @servicetypeid) AS vAgeBandGenderClaims_1" OnSelecting="SqlDataSource8_Selecting">
                    <SelectParameters>
                                <asp:ControlParameter ControlID="dpStartDate" Name="startdate" PropertyName="SelectedDate" />
                                <asp:ControlParameter ControlID="dpEndDate" Name="enddate" PropertyName="SelectedDate" />
                        <asp:ControlParameter ControlID="dlServiceType" Name="servicetypeid" PropertyName="SelectedValue" Type="String" />
            ...
            <ChartTitle Text="Claim Amount - Age Band">
                ...
                <asp:SqlDataSource ID="SqlDataSource9" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT AGEBAND, MALES, FEMALES FROM dbo.vAgeBandGenderClaimAmount(@startdate, @enddate, @servicetypeid) AS vAgeBandGenderClaimAmount_1" OnSelecting="SqlDataSource9_Selecting">
                    <SelectParameters>
                                <asp:ControlParameter ControlID="dpStartDate" Name="startdate" PropertyName="SelectedDate" />
                                <asp:ControlParameter ControlID="dpEndDate" Name="enddate" PropertyName="SelectedDate" />
                        <asp:ControlParameter ControlID="dlServiceType" Name="servicetypeid" PropertyName="SelectedValue" Type="String" />
                ...
                <asp:SqlDataSource ID="SqlDataSource10" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT AGEBAND, TOTALCLAIMS FROM dbo.vAgeBandAllClaims(@startdate, @enddate, @servicetypeid) AS vAgeBandAllClaims_1" OnSelecting="SqlDataSource10_Selecting">
                    <SelectParameters>
                                <asp:ControlParameter ControlID="dpStartDate" Name="startdate" PropertyName="SelectedDate" />
                                <asp:ControlParameter ControlID="dpEndDate" Name="enddate" PropertyName="SelectedDate" />
                        <asp:ControlParameter ControlID="dlServiceType" Name="servicetypeid" PropertyName="SelectedValue" Type="String" />
                ...
                <asp:SqlDataSource ID="SqlDataSource11" runat="server" ConnectionString="<%$ ConnectionStrings:ConnectionString %>" SelectCommand="SELECT AGEBAND, TOTALCLAIMAMOUNT FROM dbo.vAgeBandAllClaimAmount(@startdate, @enddate, @servicetypeid) AS vAgeBandAllClaimAmount_1" OnSelecting="SqlDataSource11_Selecting">
                    <SelectParameters>
                                <asp:ControlParameter ControlID="dpStartDate" Name="startdate" PropertyName="SelectedDate" />
                                <asp:ControlParameter ControlID="dpEndDate" Name="enddate" PropertyName="SelectedDate" />
                        <asp:ControlParameter ControlID="dlServiceType" Name="servicetypeid" PropertyName="SelectedValue" Type="String" />
