...
{
    public partial class ClaimsAttendance_ServiceType : System.Web.UI.Page
    {
        ...
        protected void loadDashboard(int serviceTypeId)
        {
            using (SqlConnection connection = new SqlConnection(connectionString))
            {
                using (SqlCommand command = new SqlCommand("StatsDashboard_ClaimsAttendance_BySType", connection))
                {
                    ...
                    command.Parameters.Add("@ServiceTypeId", SqlDbType.Int).Value = serviceTypeId;
        ...
        {
            loadDashboard(int.Parse(dlServiceType.SelectedValue));
