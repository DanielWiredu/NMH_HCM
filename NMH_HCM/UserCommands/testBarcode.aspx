<%@ Page Title="" Language="C#" MasterPageFile="~/Home.Master" AutoEventWireup="true" CodeBehind="testBarcode.aspx.cs" Inherits="NMH_HCM.UserCommands.testBarcode" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
     <div class="box box-default">
            <div class="box-header with-border">
              <h3 class="box-title">Barcode Test</h3>
                        ...
                        <div class="modal-body">
                          ...
                          <div class="form-group">
                            ...
                            <div class="form-group">
                             ...
                             <div class="col-md-6">
                                 <label>Image </label>
                                 <asp:Image ID="image" runat="server" Width="80%" Height="150px" />
                             </div>
                             </div>
                         </div>
                       </div>
