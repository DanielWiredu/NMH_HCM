<%@ Page Title="" Language="C#" MasterPageFile="~/MYHEALTH/MyHealthHome.Master" AutoEventWireup="true" CodeBehind="NewlyClosedProviders.aspx.cs" Inherits="NMH_HCM.MYHEALTH.UserReports.NewlyClosedProviders" %>
                 ...
                 <div class="modal-content">
                        <div class="modal-body">
                            ...
                            <div>
                                ...
                                <asp:SqlDataSource ID="newlyClosedSource" runat="server" ConnectionString="<%$ ConnectionStrings:myHealthDBConnectionString %>" SelectCommand="select * from payment_table_rx where nmhPull = 0">
                                </asp:SqlDataSource>
                            </div>
                       </div>
